...
nr = 150;                % number of components to be found
params.gSiz = 16;        % maximum size of neuron in pixels
params.gSig = 10;         % std of gaussian (size of neuron)        
...
P.d1 = d1; P.d2 = d2; P.dist = params.gSiz;
...
P.method = 'project';
[C,f,~] = update_temporal_components(Yr,A,b,C,f,P);
